...
class Order {
    ...
    addproduct() {
        cy.contains('Faded Short Sleeve T-shirts').first().click()
    ...
    modify_cart() {
        ...
        cy.get('.logo').click()
        cy.contains('Printed Chiffon Dress').first().click()
    ...
    cart_validation() {
        cy.get('[title="View my shopping cart"]').should('not.have.text', '0 Product')
    }
}
